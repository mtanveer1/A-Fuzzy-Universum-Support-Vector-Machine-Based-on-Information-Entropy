             ...
             for epi = 1:length(eps)
				...
				for mv = 1:length(mus)
                   ...
                   %% testing and training
                                [accuracy_with_zero,time] = test_train(Data, B_t, U,c1,mu,epsilon);
...
%             
 ...
 [accuracy,time] = test_train(Data, B_t, U, min_c1, min_mu, min_e);
 fprintf(file1,'%s\t%g\t%g\t%g\t%g\t%g\t%g\t%g\n',file,size(A,1),size(A_test,1),accuracy,min_c1,min_e,min_mu,time);
end